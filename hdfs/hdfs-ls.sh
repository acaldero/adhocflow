...
# Run hdfs-cp
echo env CLASSPATH=$FULL_CLASSPATH LD_LIBRARY_PATH=$FULL_LD_LIBRARY_PATH $BASE_DIR/hdfs-cp -a stats4hdfs -h $PARAMETER_HDFS_DIR -f $PARAMETER_HDFS_LIST
     env CLASSPATH=$FULL_CLASSPATH LD_LIBRARY_PATH=$FULL_LD_LIBRARY_PATH $BASE_DIR/hdfs-cp -a stats4hdfs -h $PARAMETER_HDFS_DIR -f $PARAMETER_HDFS_LIST

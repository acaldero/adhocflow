...
# Run hdfs-cp
env CLASSPATH=$FULL_CLASSPATH LD_LIBRARY_PATH=$FULL_LD_LIBRARY_PATH $BASE_DIR/hdfs-cp -a $PARAMETER_HDFS_CMD -h $PARAMETER_HDFS_DIR -f $PARAMETER_HDFS_LIST -l $PARAMETER_CACHE_DIR
